...
const BestSellerSection = (): JSX.Element => {
  ...
  return (
    <section ref={ref} className='h-[600vh] max-[391px]:h-[400vh] max-[391px]:max-h-full max-[391px]:place-content-center w-full flex justify-center items-center bg-[#0C0C0C]'>
