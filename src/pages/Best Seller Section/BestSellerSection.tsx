...
const BestSellerSection = (): JSX.Element => {
  ...
  return (
    <section ref={ref} className='h-[600vh] max-[769px]:h-full max-[769px]:max-h-[400vh] max-[391px]:place-content-center w-full flex justify-center items-center bg-[#0C0C0C]'>
